...
export default function ReviewsPage() {
  ...
  const visibleReviews = publishedReviews.filter(
    (review) => filter === "all" || review.rating === filter,
  );
  return (
    <div className="space-y-8">
      <ReviewsHeader />
      <ReviewStats />
      <PendingReviews onWrite={setSelectedProduct} />
      ...
      {(selectedProduct || editing) && (
        <ReviewDialog
          product={selectedProduct ?? editing!.product}
          onClose={() => {
